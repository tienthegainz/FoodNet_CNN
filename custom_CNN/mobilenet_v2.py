...
def build_mobilenet_v2(n_classes):
    ...
    base_model = MobileNetV2(weights='imagenet', include_top=False, input_tensor=Input(shape=(200, 200, 3)))
    x = base_model.output
...
if __name__ == '__main__':
    ...
    plot_model(model, to_file='../custom_mobilenet_v2.png')
